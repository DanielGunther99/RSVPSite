...
function Header() {
  ...
  const inactiveClass =
    "inline-block hover:border-gray-300 rounded-t-lg py-4 px-4 text-4xl font-medium text-center border-transparent border-b-2 text-gray-400 hover:text-gray-300";
